...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/mruniquehacker/NOVALAND-X-BOT';
            const apiUrl = 'https://api.github.com/repos/mruniquehacker/NOVALAND-X-BOT';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* NOVALAND-X-BOT\n`;
