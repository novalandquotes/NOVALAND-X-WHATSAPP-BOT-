...
<img src="utils/bot_image.jpg" alt="NOVALAND X BOT" width="260">

</div>

NOVALAND X BOT is a WhatsApp MD bot built on top of the **Baileys** library.  
...
<a href="https://github.com/mruniquehacker/NOVALAND-X-BOT/fork" target="_blank">
...
> This creates your own copy of `NOVALAND-X-BOT` under your GitHub account.
...
```bash
git clone https://github.com/mruniquehacker/NOVALAND-X-BOT.git
cd NOVALAND-X-BOT
```
